...
// 1. Interface Lengkap (Sesuai Database & Excel)
interface Jemaat {
  id: number;
  no_kk: string;
  nama_lengkap: string;
  ...
  tanggal_perkawinan?: string; // Bisa null
...
const DataJemaat: React.FC = () => {
  ...
  return (
    <>
      <PageBreadcrumb pageTitle="Data Jemaat (Format KK)" />
          ...
          <div className="flex flex-col">
            ...
            {loading ? (
              ...
              members.map((member, key) => (
                <div className={`grid grid-cols-3 sm:grid-cols-6 ${key === members.length - 1 ? '' : 'border-b border-gray-200 dark:border-gray-800'}`} key={member.id}>
                  ...
                  <div className="flex items-center justify-center p-2.5 xl:p-5">
                    <p className="text-sm text-gray-600 dark:text-gray-400">{member.seksi}</p>
                  </div>
      ...
      {/* ================= MODAL DETAIL POPUP (PERBAIKAN Z-INDEX) ================= */}
      {isModalOpen && selectedJemaat && (
        ...
        >
          {/* Wrapper Modal agar bisa diklik luar untuk tutup (opsional) */}
          ...
          <div className="relative w-full max-w-lg rounded-xl bg-white p-8 shadow-2xl dark:bg-boxdark dark:border dark:border-strokedark transform transition-all scale-100">
            ...
            {/* Body Modal - Grid Layout yang Lebih Rapi */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
              ...
              <div>
                ...
                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border
                   ${selectedJemaat.hubungan_keluarga === 'Kepala Keluarga' 
              ...
              <div>
                ...
                <p className="font-medium text-gray-800 dark:text-gray-200">
                  {selectedJemaat.tempat_lahir}, {selectedJemaat.tanggal_lahir}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium text-gray-800 dark:text-gray-200">
                  {selectedJemaat.status_pernikahan}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium text-gray-800 dark:text-gray-200">
                  {selectedJemaat.tanggal_perkawinan && selectedJemaat.tanggal_perkawinan !== '0000-00-00' 
                    ? selectedJemaat.tanggal_perkawinan 
                    : '-'}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium text-gray-800 dark:text-gray-200">
                  {selectedJemaat.anggota_jemaat}
                </p>
              </div>

              {/* Seksi / Unsur - Full Width dengan Highlight */}
              <div className="col-span-1 md:col-span-2 bg-blue-50 dark:bg-gray-800 p-4 rounded-lg border border-blue-100 dark:border-gray-600">
                <label className="block text-xs font-bold text-blue-400 uppercase tracking-wide mb-1">
                  Seksi / Unsur Pelayanan
                </label>
                <p className="text-lg font-bold text-gray-900 dark:text-white">
                  {selectedJemaat.seksi}
                </p>
              </div>
            ...
            <div className="mt-8 pt-4 border-t border-gray-100 dark:border-gray-700 flex justify-end">
              <button 
                onClick={handleCloseDetail}
                className="rounded-lg bg-gray-100 px-6 py-2.5 font-medium text-gray-600 hover:bg-gray-200 transition dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
              >
                Tutup
              </button>
            </div>
